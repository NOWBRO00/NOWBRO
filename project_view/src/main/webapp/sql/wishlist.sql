...
INSERT INTO WISHLIST (WISHLIST_NUM,WISHLIST_MEMBER_ID,WISHLIST_PRODUCT_NUM) VALUES (COALESCE((SELECT MAX(WISHLIST_NUM) FROM WISHLIST),0)+1,'nowbro@naver.com',18);
INSERT INTO WISHLIST (WISHLIST_NUM,WISHLIST_MEMBER_ID,WISHLIST_PRODUCT_NUM) VALUES (COALESCE((SELECT MAX(WISHLIST_NUM) FROM WISHLIST),0)+1,'nowbro@naver.com',28);
INSERT INTO WISHLIST (WISHLIST_NUM,WISHLIST_MEMBER_ID,WISHLIST_PRODUCT_NUM) VALUES (COALESCE((SELECT MAX(WISHLIST_NUM) FROM WISHLIST),0)+1,'nowbro@naver.com',4);
INSERT INTO WISHLIST (WISHLIST_NUM,WISHLIST_MEMBER_ID,WISHLIST_PRODUCT_NUM) VALUES (COALESCE((SELECT MAX(WISHLIST_NUM) FROM WISHLIST),0)+1,'nowbro@naver.com',3);
