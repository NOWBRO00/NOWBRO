...
-- 샘플
INSERT INTO RESERVATION (RESERVATION_NUM,RESERVATION_PAYMENT_NUM,RESERVATION_REGISTRATION_DATE) VALUES(COALESCE((SELECT MAX(RESERVATION_NUM) FROM RESERVATION),0)+1,1,'2024-09-08');
...
INSERT INTO RESERVATION (RESERVATION_NUM,RESERVATION_PAYMENT_NUM,RESERVATION_REGISTRATION_DATE) VALUES(COALESCE((SELECT MAX(RESERVATION_NUM) FROM RESERVATION),0)+1,3,'2024-09-10');
...
INSERT INTO RESERVATION (RESERVATION_NUM,RESERVATION_PAYMENT_NUM,RESERVATION_REGISTRATION_DATE) VALUES(COALESCE((SELECT MAX(RESERVATION_NUM) FROM RESERVATION),0)+1,5,'2024-09-13');
INSERT INTO RESERVATION (RESERVATION_NUM,RESERVATION_PAYMENT_NUM,RESERVATION_REGISTRATION_DATE) VALUES(COALESCE((SELECT MAX(RESERVATION_NUM) FROM RESERVATION),0)+1,6,'2024-09-13');
