...
#passwordModal, #passwordCheckModal, #passwordChangeModal, #newPasswordModal {
	display: none;
	position: fixed;
	z-index: 1;
	left: 0;
				...
				<div class="row g-0">
					<div class="col-md-4">
						<form id="imageChangeForm" action="updateProfile.do" method="POST"
							...
							<!-- <img alt="${member.member_id}님의 프로필 이미지" src="images/${member.member_profile}"> -->
							<input type=file name="member_profile" id="profile"
								style="display: none"> <span id="fileMsg"
					...
					<div class="col-md-8">
						<div class="card-body">
							...
							<button type="submit" id="submitBtn"
								...
								완료</button>
							<!-- 비밀번호 변경 -->
							<button type="button" class="btn btn-outline-secondary" style="width: 140px" onclick="document.getElementById('passwordCheckModal').style.display='block'">비밀번호 변경</button>
							<!-- 회원탈퇴 -->
							<button type="button" class="btn btn-outline-secondary" style="width: 140px" onclick="document.getElementById('passwordModal').style.display='block'">회원 탈퇴</button>
						</div>
					</div>
					...
					<div id="passwordModal">
						<div id="modalContent">
							<form id="deleteMemberForm" method="POST" action="deleteMember.do">
								비밀번호를 입력하세요.<br> 
								<input type="password" class="checkPassword" name="member_password" autoComplete="off"><br>
								<span class="errorMsg"></span><br>
								<button id="deleteMemberBtn" type="submit" class="btn btn-outline-secondary" style="width: 140px; display: inline;">확인</button>
								<button type="button" class="btn btn-outline-secondary" style="width: 140px; display: inline;" onclick="document.getElementById('passwordModal').style.display='none'">취소</button>
								<br>
							</form>
						</div>
					</div>
					...
					<div id="passwordCheckModal">
						...
						<div id="modalContent">
							<form>
								...
								<input type="password" class="checkPassword" name="member_password" autoComplete="off"><br>
								<span class="errorMsg"></span><br>
								<button id="checkPasswordBtn" type="button" class="btn btn-outline-secondary" style="width: 140px; display: inline;"   onclick="document.getElementById('newPasswordModal').style.display='block'" >확인</button>
								<button type="button" class="btn btn-outline-secondary" style="width: 140px; display: inline;" onclick="document.getElementById('passwordCheckModal').style.display='none'">취소</button>
							</form>
						</div>
					</div>
					...
					<div id="newPasswordModal">
						<div id="modalContent">
							<form id="passwordChangeForm" method="POST" action="updatePassword.do">
								변경할 비밀번호: <input type="password" id="password" name="member_password" autoComplete="off"><br>
								비밀번호 확인: <input type="password" id="confirmPassword" autoComplete="off"><br> 
								<span id="passwordMsg"></span>
								<button type="submit" class="btn btn-outline-secondary" style="width: 140px;">변경</button>
								<button type="button" class="btn btn-outline-secondary" style="width: 140px; display: inline;" 
