...
<div id="calendar">
    ...
    <div id="dates"></div>
    <!-- 예약 폼 -->
    <form id="reservationForm" action="makeReservation.do" method="POST">
        <!-- 선택된 날짜를 저장하는 숨겨진 입력 필드 -->
        <input type="hidden" id="selectedDate" name="date">
        <input name="product_num"  value="${product.product_num}" style="visibility: hidden;"><br>
        <div style = "display:flex; justify-content: space-between;">
        	<span style="font-size:30px; color:#007bff;">금액 : ${product.product_price}원</span>
        	<!-- 예약 버튼 -->
...
<script>
    ...
    function selectDate(dateDiv, date, year, month) {
        ...
        selectedDateInput.value = localDateString;
    }
