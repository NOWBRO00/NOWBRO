			...
			<div class="card">
				...
				<div class="row g-0">
					<div class="col-md-4">
						<br>
						<!-- 상품 썸네일 -->
						<img src="" class="rounded mx-auto d-block" alt="상품 사진" style="margin-left:10px;">
						<br>
					</div>
					<div class="col-md-8">
						<div class="card-body">
							...
							<div class="input-group mb-3" style="display: flex; align-items: flex-end; height: 40px;">
								<h3 id="product_name">${product.product_name}상품명</h3>
							...
							<div class="input-group mb-3">
								<h5>사용 예정일</h5>
								<input type="text" id="reservation_date" class="form-control" value="${reservation_date}">
							</div>
							<span id="nameMsg"></span>
							<!-- 예약자명 -->
							<input type="hidden" id="member_id" value="${member.memebr_id}"/>
							<input type="hidden" id="member_phone" value="${member.memebr_phone}"/>
							<div class="input-group mb-3">
								<h5>예약자명</h5>
								<input type="text" class="form-control" value="${member.member_name}">
							</div>
							<span id="nicknameMsg"></span>
							<!-- 예약자 전화번호 -->
							<div class="input-group mb-3">
								<h5>전화번호</h5>
								<input type="text" class="form-control" value="${member.member_phone}">
							</div>
							<!-- 결제금액 -->
							<div class="input-group mb-3">
								<h5>결제금액</h5>
								<input type="text" id="amount" class="form-control" value="${product.product_price}">
							</div>
							<!-- 결제하기 버튼 -->
